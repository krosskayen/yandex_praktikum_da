...
| [Исследование надёжности заёмщиков ](https://github.com/krosskayen/yandex_praktikum_da/tree/main/food_establishment) | Исследование влияния ряда факторов на факт возврата кредита в срок.| *`python` (`pandas`, `numpy`, `pymystem3`, `collections`)* |
