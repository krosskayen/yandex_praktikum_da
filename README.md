...
| [Анализ объектов питания в Москве](https://github.com/krosskayen/yandex_praktikum_da/blob/main/food_establishment/food_establishments.ipynb) | На основе имеющихся данных о заведениях общественного питания, сделать рекомендации по основным параметрам, которые необходимо учесть для открытия кафе необычного формата в Москве.| *`python` (`pandas`, `matplotlib`, `seaborn`, `re`)*, *`визуализация данных`* |
